...
func (m *MockStorage) UploadImage(ctx context.Context, image string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStorageMockRecorder) UploadImage(ctx, image interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UploadImage", reflect.TypeOf((*MockStorage)(nil).UploadImage), ctx, image)
}
