...
func (mr *MockStoreServiceRepositoryMockRecorder) DeleteStores(ctx, storeIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreServiceRepositoryMockRecorder) ListStores(ctx, page, pageSize interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreServiceRepositoryMockRecorder) UpdateStore(ctx, update interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
