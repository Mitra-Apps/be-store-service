...
func (m *MockService) OpenCloseStore(ctx context.Context, storeID string, isActive bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) OpenCloseStore(ctx, storeID, isActive interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OpenCloseStore", reflect.TypeOf((*MockService)(nil).OpenCloseStore), ctx, storeID, isActive)
}
